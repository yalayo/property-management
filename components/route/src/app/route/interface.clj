...
(defmethod ig/init-key ::internal-routes [_ {:keys [operations-routes properties-routes tenants-routes]}]
  (into #{} (concat operations-routes properties-routes tenants-routes)))