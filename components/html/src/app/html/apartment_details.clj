   ...
   [:div
    ...
    [:dl
     ...
     [:div
      ...
      [:dt {:class "text-sm/6 font-medium text-gray-900"} "Apartment name"]
      [:dd
     ...
     [:div
      {:class "px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0"}
      [:dt {:class "text-sm/6 font-medium text-gray-900"} "About"]
      [:dd
       {:class "mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0"}
       "Fugiat ipsum ipsum deserunt culpa aute sint do nostrud anim incididunt cillum culpa consequat. Excepteur qui ipsum aliquip consequat sint. Sit id mollit nulla mollit nostrud in ea officia proident. Irure nostrud pariatur mollit ad adipisicing reprehenderit deserunt qui eu."]]
     [:div
      {:class "px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0"}
      [:dt {:class "text-sm/6 font-medium text-gray-900"} "Attachments"]
      [:dd
         ...
         [:div
          ...
          [:div
           ...
           [:span
            ...
            "monthly_report.pdf"]
           [:span {:class "shrink-0 text-gray-400"} "2.4mb"]]]
         [:div
          {:class "ml-4 shrink-0"}
          [:a
           {:href "#",
        ...
        [:li
         ...
         [:div
          ...
          [:div
           ...
           [:span
            {:class "truncate font-medium"}
            "apartment_details.pdf"]
           [:span {:class "shrink-0 text-gray-400"} "4.5mb"]]]
         [:div
          {:class "ml-4 shrink-0"}
          [:a
           {:href "#",
